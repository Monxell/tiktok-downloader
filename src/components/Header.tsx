      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            {history.length > 0 && (
              <span className="absolute -right-1.5 -top-1.5 flex h-5 w-5 items-center justify-center rounded-full border-2 border-foreground bg-destructive text-[9px] font-black text-white shadow-[1px_1px_0_0_hsl(var(--foreground))]">
